...
var conf_content_ue = hereDoc(function() {/*!
      <div id="ipm-content-inner">
        ...
        <div class="left-col-box">
          ...
          <img src="images/multi-platform.png" alt="" id="multiPlatformImage" class="multiplat">
        </div>
      ...
      <div class="darkbg">
        <div id="ipm-content-inner" class="darkbg">
          ...
          <div class="left-col-box" styl>
            ...
            <img src="images/multi-platform.png" alt="" style="margin-top: 12px;" class="multiplat">
...
// AA content block
var conf_content_aa = hereDoc(function() {/*!
      <div id="ipm-content-inner" class="aa-promo">

        <div id="aa-boxes">
          <img src="images/boxes-aa.png" alt="" class="aabox">
        </div>
        
        <div id="aa-text">
          <div class="benefits-list">

            <div class="aa_li"><span class="l_aaAllTools"></span></div>
            <div class="aa_li"><span class="l_aaWinMacLinux"></span></div>
            <div class="aa_li"><span class="l_aaFreeUpgrades"></span></div>
            <div class="aa_li"><span class="l_aaVeracode"></span></div>
            <div class="aa_li"><span class="l_aaActivations"></span></div>

          </div>
        </div>

        <p><span class="l_aaPromo"></span></p>
      </div>
...
conf_day_content = {
  ...
  30 : conf_content_ue,
  29 : conf_content_f_themes,
  28 : conf_content_f_multicaret,
...
conf_apps = {
  ...
  uew : {
    ...
    urls: {
      ...
      ch_buynew : 'https://ultraeditcn.com/redirect/?product=ultraedit&referer=daoqi-new',
      buyupg    : 'ue_paid_upgrade.html',
      ch_buyupg : 'https://ultraeditcn.com/redirect/?product=ultraedit&referer=upgrade',
  ...
  ues : {
    ...
    urls: {
      ...
      ch_buynew : 'https://ultraeditcn.com/redirect/?product=uestudio&referer=daoqi-new',
      buyupg    : 'ues_paid_upgrade.html',
      ch_buyupg : 'https://ultraeditcn.com/redirect/?product=uestudio&referer=upgrade',
