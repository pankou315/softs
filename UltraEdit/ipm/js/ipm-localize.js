...
//---------------------
  ...
  bftMultiPlatform: {
    ...
    fr: 'Comprend les versions <strong>Windows</strong>, <strong>Mac</strong> et <strong>Linux</strong>',
    es: 'Incluye versiones para <strong>Win</strong>, <strong>Mac</strong> y <strong>Linux</strong>',
    it: 'Include versioni <strong>Win</strong>, <strong>Mac</strong> e <strong>Linux</strong>',
    ko: '<strong>Win</strong>, <strong>Mac</strong>, <strong>Linux</strong> 버전이 포함됩니다',
    jp: 'それには<strong>Win</strong>、<strong>Mac</strong>、<strong>Linux</strong>バージョンがあります',
  ...
  bftThreeInstalls: {
    ...
    fr: 'Installation sur trois ordinateurs',
    es: 'Instalación en hasta 3 equipos',
    it: 'Installazione consentita su un massimo di 3 macchine',
    ko: '최대 3대까지 설치',
  ...
  bftFreeUpgrades: {
    ...
    de: 'Kostenloses Upgrade auf die nächste Version',
    fr: 'Mise à jour gratuite vers la nouvelle version',
    es: 'Actualización gratuita a la próxima versión',
    it: 'Aggiornamento gratuito all\'uscita della prossima versione',
    ko: '새 버전으로 무료 업그레이드',
    jp: '次回リリースの無償アップグレード',
    ch: '免费升级到下一个版本',
    cht: '免費升級到下一個版本'
  ...
  bftTechSupport: {
    ...
    fr: 'Soutien tech. illimité pour la durée de vie du produit',
    es: 'Soporte técnico ilimitado de por vida',
    it: 'Assistenza tecnica illimitata a vita',
    ko: '평생 무제한 기술 지원',
    jp: '生涯無制限のテクニカルサポート',
    ch: '无限制的终身技术支持',
    cht: '無限制的終身技術支援'
  ...
  bftUCProFree: {
    ...
    fr: '<span class="bdlname"></span>  Pro sans aucun frais supplémentaire',
    es: '<span class="bdlname"></span>  Pro sin coste adicional',
    it: '<span class="bdlname"></span>  Pro senza costi aggiuntivi',
    ko: '<span class="bdlname"></span>  Pro(별도 비용 없음)',
    jp: '<span class="bdlname"></span>  Pro を追加費用なしでご利用いただけます',
...
//---------------------
  ...
  licenseApp: {
    ...
    fr: 'Délivrer une licence pour <span class="appname"></span>',
    es: 'Obtener licencia para <span class="appname"></span>',
...
//---------------------
  ...
  upgradeueuc: {
    ...
    fr: 'Mettre à niveau <span class="appabbr"></span>, + <span class="bdlabbr"></span> :',
    es: 'Actualizar <span class="appabbr"></span> + <span class="bdlabbr"></span>:',
    it: 'Aggiorna <span class="appabbr"></span>, aggiungi <span class="bdlabbr"></span>:',
    ko: '<span class="appabbr"></span> 업그레이드 + <span class="bdlabbr"></span>:',
    jp: '<span class="appabbr"></span>をアップグ、UCを追加：',
    ch: '升级 <span class="appabbr"></span>，新增 <span class="bdlabbr"></span>：',
    cht: '升級 <span class="appabbr"></span>、新增 <span class="bdlabbr"></span>：'
  },

  aaPromo: {
    en: 'Get <span class="appname"></span> <em>plus</em> all the tools you need... <a href="https://www.ultraedit.com/products/idm-all-access.html" target="_blank">Learn more about All Access</a>',
    ptb: 'Obtenha <span class="appname"></span> <em>plus</em> todas as informações que você precisa...<br><a href="https://www.ultraedit.com/products/idm-all-access.html" target="_blank">Saiba mais sobre Todos os Acessos</a>',
    de: 'Holen Sie sich <span class="appname"></span> <em>plus</em> alle Werkzeuge, die Sie brauchen...<br><a href="https://www.ultraedit.com/products/idm-all-access.html" target="_blank">Mehr über All Access erfahren</a>',
    fr: 'Obtenez <span class="appname"></span> <em>plus</em>tous les outils dont vous avez besoin...<br><a href="https://www.ultraedit.com/products/idm-all-access.html" target="_blank">En savoir plus sur Tous les accès</a>',
    es: 'Obtenga <span class="appname"></span> <em>plus</em> todas las herramientas que necesita...<br><a href="https://www.ultraedit.com/products/idm-all-access.html" target="_blank">Conozca más acerca de Acceso total</a>',
    it: 'Ottieni <span class="appname"></span> <em>plus</em> tutti gli strumenti che ti servono...<br><a href="https://www.ultraedit.com/products/idm-all-access.html" target="_blank">Per ulteriori informazioni Accesso Tutti</a>',
    ko: '<span class="appname"></span> <em>및</em> 귀하가 필요로 하는 모든 도구를 받으십시오...<br><a href="https://www.ultraedit.com/products/idm-all-access.html" target="_blank">All Access에 대해 자세히 알아보기</a>',
    jp: '必要な <span class="appname"></span> <em>plus</em> ツールをすべて追加...<br><a href="https://www.ultraedit.com/products/idm-all-access.html" target="_blank">All Accessについてさらに詳しく</a>',
    ch: '还可获取<span class="appname"></span><em></em>您需要的所有工具……<a href="https://www.ultraedit.com/products/idm-all-access.html" target="_blank">详细了解 All Access</a>',
    cht: '取得 <span class="appname"></span> <em>plus</em> 您所需的所有工具... <a href="https://www.ultraedit.com/products/idm-all-access.html" target="_blank">進一步瞭解 All Access</a>'
  },

  aaAllTools: {
    en: 'All our award winning tools',
    ptb: 'Todas as nossas ferramentas',
    de: 'Alle unseren preisgekrönten Werkzeuge',
    fr: 'Tous nos outils primés',
    es: 'Todas nuestras herramientas premiadas',
    it: 'Tutti i nostri strumenti pluripremiati',
    ko: '수상 경력에 빛나는 모든 도구',
    jp: 'すべてのアワード獲得ツール',
    ch: '所有我们屡获殊荣的工具',
    cht: '我們所有獲獎的工具'
  ...
  aaWinMacLinux: {
    en: 'Windows, Mac, Linux versions',
    ptb: 'Versões Windows, Mac, Linux',
    de: 'Windows-, Mac-, Linux-Versionen',
    fr: 'Versions Windows, Mac, Linux',
    es: 'Versiones Windows, Mac, Linux',
    it: 'Versioni Windows, Mac, Linux',
    ko: 'Windows, Mac, Linux 버전',
    jp: 'Windows、Mac、Linuxバージョン',
    ch: 'Windows、Mac、Linux 版本',
    cht: 'Windows、Mac、Linux 版本'
  },

  aaFreeUpgrades: {
    en: 'Free updates for all titles',
    ptb: 'Atualizações gratuitas para todos os títulos',
    de: 'Kostenlose Updates für alle Titel',
    fr: 'Mises à jour gratuites pour tous les produits',
    es: 'Actualizaciones gratuitas para todos los títulos',
    it: 'Aggiornamenti gratuiti per tutti i titoli',
    ko: '모든 타이틀에 대한 무료 업데이트',
    jp: 'すべてのタイトルの無料アップデート',
    ch: '所有标题均可免费更新',
    cht: '免費更新所有標題'
  },

  aaVeracode: {
    en: 'Veracode verified secure',
    ptb: 'Veracode verificado como seguro',
    de: 'Sicher-Verifizierung von Veracode',
    fr: 'Veracode vérifié comme sûr',
    es: 'Veracode verificado como seguro',
    it: 'Sicurezza garantita Veracode',
    ko: 'Veracode 인증 보안',
    jp: 'Veracode による検証されたセキュリティ',
    ch: '获得 Veracode 认证的安全性',
    cht: '經 Veracode 驗證的安全性'
  },

  aaActivations: {
    en: '5 activations for personal use',
    ptb: '5 ativações para uso pessoal',
    de: '5 Aktivierungen zum persönlichen Gebrauch',
    fr: '5 activations pour un usage personnel',
    es: '5 activaciones para uso personal',
    it: '5 attivazioni per utilizzo personale',
    ko: '5인용 활성화 지원',
    jp: '個人使用のための5つのアクティベーション',
    ch: '5 个激活供个人使用',
    cht: '個人使用可啟用 5 次'
  },
...
//---------------------
  ...
  f_MultiCaretHead: {
    ...
    es: 'Editar en varios lugares del archivo a la vez',
  ...
  f_ThemesHead: {
    ...
    fr: 'Sélectionnez vos propres disposition et thème',
  ...
  f_CompareHead: {
    ...
    ptb: 'A licença de seu <span class="appname"></span> inclui o <span class="bdlabbr">UC</span> Pro <strong>sem custo adicional!</strong>',
    de: 'Ihre <span class="appname"></span> Lizenz beinhaltet <span class="bdlabbr">UC</span> Pro <strong>ohne zusätzliche Kosten!</strong>',
    fr: 'Votre <span class="appname"></span> licence comprend <span class="bdlabbr">UC</span> Pro <strong>sans aucun frais supplémentaire !</strong>',
    ...
    jp: 'お使いの <span class="appname"></span> ライセンスでは、追加料金なしで  <span class="bdlabbr">UC</span> Pro<strong> をご利用いただけます。</strong>',
  ...
  f_findReplaceHead: {
    ...
    it: 'Trova/sostituisci in un singolo file, più file e altro',
    ko: '단일 파일, 복수 파일 찾기/바꾸기 등',
    jp: '単一ファイルや複数ファイルの検索や置換など多機能',
    ch: '在单个文件、多个文件中查找/替换',
  ...
  f_findReplace: {
    ...
    fr: 'Appuyez sur Ctrl + F pour rechercher rapidement du texte avec Quick Find et sur Ctrl + F une deuxième fois pour ouvrir la boîte de dialogue de la recherche.  Ctrl + R permet d\'ouvrir la boîte de dialogue du remplacement.  Toutes les options de recherche et de remplacement sont disponibles dans le menu Recherche. <br><br> Les options de recherche /remplacement avancées comprennent les expressions régulières, la recherche et le remplacement dans les fichiers, la recherche dans les colonnes, et plus encore...',
    es: 'Pulse Ctrl + F para buscar rápidamente texto con la búsqueda rápida o presione Ctrl + F otra vez para abrir el cuadro de diálogo principal Buscar.  Ctrl + R abre el cuadro de diálogo Reemplazar.  Todas las opciones de buscar y reemplazar están disponibles en el menú Buscar. <br><br> Las opciones avanzadas de búsqueda y sustitución incluyen expresiones regulares, buscar y reemplazar en archivos, buscar en columnas, y mucho más...',
    it: 'Premere Ctrl + F per la ricerca veloce di testo con la funzione Ricerca veloce oppure premere Ctrl + F una seconda volta per aprire la finestra di dialogo principale Trova.  La combinazione Ctrl + R apre la finestra di dialogo Sostituisci.  Tutte le opzione di ricerca e sostituzione sono disponibili nel menu Ricerca. <br><br> Le opzioni avanzate di ricerca / sostituzione includono espressioni regolari, trova e sostituisci nei file, cerca nella colonna e molto ancora.',
    ...
    jp: 'テキストのクイック検索を開くには、［Ctrl］キーと ［F］ を同時に押します。メインの検索ダイアログを開くには、もう一度 ［Ctrl］キーと ［F］ を同時に押します。［Ctrl］キーと ［R］ を同時に押すと、置換ダイアログが開きます。検索と置換のオプションはすべて [検索] メニューから利用できます。<br><br>高度な検索/置換オプションでは、正規表現の利用、ファイル内の検索・置換、列内の検索などの多くの機能が利用できます。',
  ...
  f_FTPHead: {
    ...
    es: 'Editar archivos desde servidores FTP/SFTP',
  ...
  f_TemplatesHead: {
    ...
    es: 'Plantillas inteligentes/fragmentos de código',
    it: 'Template intelligenti / frammenti codici',
    ko: '스마트 템플릿 / 코드 정보',
  ...
  f_SortHead: {
    ...
    fr: 'Trier le texte sélectionné ou le fichier dans son ensemble',
    es: 'Ordenar texto seleccionado o todo el archivo',
  ...
  f_Sort: {
    ...
    it: 'Per ordinare velocemente un file o una selezione alfabeticamente o numericamente, in ordine crescente o decrescente. Per ordinare sulla base di uno o più intervalli di colonna e rimuovere opzionalmente inserimenti duplici.  Per ordinare con opzioni basi o avanzate. <br><br> L\'ordinamento può aiutarti a leggere i file di registro, a ordinare i campi in database di file oppure a organizzare qualsiasi testo. È possibile accedere alla funzione Ordina nel menu <strong>File</strong>.',
    ...
    jp: '単一または選択されたファイルを、アルファベット順や数字順（昇順・降順）に素早く並び替えることができます。1つ以上の列の範囲を基に並び替えを行い、必要に応じて重複したエントリを削除します。基本的または高度な並び替えオプションが利用できます。<br><br>並び替え機能は、ログファイルの解読、フラットファイルデータベース内の項目の並べ替え、テキストの整理などに役立ちます。並び替え機能は、［<strong>ファイル</strong>] メニューからアクセスすることができます。',
  ...
  f_ScriptingHead: {
    ...
    de: 'Aufgaben mit Skripten automatisieren',
    fr: 'Automatisez vos t&acirc;ches &agrave; l\'aide de scripts',
    es: 'Automatizar tareas con Scripts',
    it: 'Automatizza le tue procedure con gli Script',
  ...
  f_Bookmarks: {
    ...
    ko: '책갈피를 이용하면 편리하게 파일 또는 코드의 중요한 위치를 저장할 수 있습니다. 책갈피를 저장하려면 간단히 <strong>CTRL</strong> + <strong>F2</strong>를 누르면 되고, 다음 책갈피로 이동하려면 <strong>F2</strong>를 그리고 이전 책갈피로 이동하려면 <strong>ALT</strong> + <strong>F2</strong>를 누르면 됩니다. <br><br>책갈피보기를 사용하면 현재문서와 지금 열려있는 모든 파일의 책갈피를 빠르게 볼 수 있습니다. 더 나아가, 책갈피 보기를 사용하여 책갈피를 편집하고 삭제할 수 있습니다.',
    jp: 'ブックマークはあなたのファイル、またはコード中の重要な場所を "保存" するのに非常に便利です。ブックマークを設定するには、<strong>CTRL</strong> + <strong>F2</strong>を押してください、次のブックマークに移動するには、<strong>F2</strong>を、また前のブックマークに移動するには、<strong>ALT</strong> + <strong>F2</strong>を押してください。 <br><br>ブックマークビュワーを利用して、アクティブドキュメント中のブックマークをすばやく見る（移動する）ことができます。またこれは同様に全ての開いているファイルに対しても有効です。さらに、ブックマークビュワーを利用して、ブックマークを編集したり、削除したりすることも可能です。',
